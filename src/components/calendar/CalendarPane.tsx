...
export const CalendarPane: React.FC = () => {
  ...
  const { selectedDate, setSelectedDate, tasks, activePane } = useApp();
  const [currentMonth, setCurrentMonth] = useState({ year: selectedDate.year, month: selectedDate.month });
  ...
  const isFocused = activePane === 'calendar';
